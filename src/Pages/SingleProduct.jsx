            ...
            <div style={{ marginTop: '80px' }}>
                ...
                <div className='top-main'>
                    ...
                    <div>
                        ...
                        <div><img class='img2' src={item} alt="image2" width="420px" /></div>
                        ) : <></>}
                    ...
                    <div>
                        <div style={{ lineHeight: '5px', marginLeft: '0px' }}>
                            <h1 style={{ color: '#F25139', textAlign: 'left', paddingLeft: '15px' }}>₹{price}<span style={{ color: 'grey', fontSize: '15px', fontWeight: '400' }}> Inclusive of all taxes</span></h1>
                            <p style={{marginTop:"15px" }}><strike style={{ color: 'grey'}}>&#8377; {off_price}</strike> save &#8377;{off_price - price} ({discount}%)</p>
                            <p style={{ color: 'orange',marginTop:"15px" }}><u>Free shipping on all orders</u></p>
                        ...
                        <div className='fav-section'>
                            ...
                            ><LoyaltyIcon></LoyaltyIcon><p>Add to Favourites</p></div>
