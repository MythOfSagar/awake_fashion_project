import {
  GET_BASKET_ITEMS_LOADING,
  GET_BASKET_ITEMS_SUCCESS,
  GET_BASKET_ITEMS_ERROR,
  ADD_ITEM_TO_BASKET_LOADING,
  ADD_ITEM_TO_BASKET_SUCCESS,
  ADD_ITEM_TO_BASKET_ERROR,
  UPDATE_BASKET_ITEMS_LOADING,
  UPDATE_BASKET_ITEMS_SUCCESS,
  UPDATE_BASKET_ITEMS_ERROR,
  REMOVE_BASKET_ITEMS_LOADING,
  REMOVE_BASKET_ITEMS_SUCCESS,
  REMOVE_BASKET_ITEMS_ERROR,
} from "./Basket.types";
...
export const getBasket = () => async (dispatch) => {
  ...
  try {
    let response = await axios.get(
      "https://fashion-database-api.vercel.app/CartPage"
    );
...
export const updateBasket = (id, payload) => async (dispatch) => {
  ...
  try {
    let response = await axios.patch(
      `https://fashion-database-api.vercel.app/CartPage/${id}`,
      {
        ...payload,
      }
    );
