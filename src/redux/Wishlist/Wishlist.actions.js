import {
    GET_WISHLIST_ITEMS_LOADING, GET_WISHLIST_ITEMS_SUCCESS
    ...
    REMOVE_WISHLIST_ITEMS_SUCCESS, REMOVE_WISHLIST_ITEMS_ERROR, RESET_WISHLIST_ITEMS
} from './Wishlist.types'
...
export const getWishlist = () => async (dispatch) => {
    ...
    try {
        let response = await axios.get("https://fashion-database-api.vercel.app/Wishlist");
...
export const addWishlist = (payload) => async (dispatch) => {
    ...
    try {
        let response = await axios.post("https://fashion-database-api.vercel.app/Wishlist", payload);
        console.log(response);
...
export const updateWishlist = (id, payload) => async (dispatch) => {
    ...
    try {
        let response = await axios.patch(`https://fashion-database-api.vercel.app/Wishlist/${id}`, {
            ...payload
        });
        console.log(response);
...
export const deleteWishlist = (id) => async (dispatch) => {
    ...
    try {
        let response = await axios.delete(`https://fashion-database-api.vercel.app/Wishlist/${id}`);
        console.log(response);
...
export const emptyWishlist = () => async (dispatch) => {
    ...
    try {
        let response = await axios.delete(`https://fashion-database-api.vercel.app/Wishlist`);
        console.log(response);
    }
    catch (e) {
        console.log(e);
